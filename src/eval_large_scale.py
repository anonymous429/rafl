...
if __name__ == '__main__':
    ...
    glob_knwl_net, nets_MACs,knwl_net_MACs = fl.init_fl_scaled(
    ...
    for round in range(args.comm_round):
        ...
        # local updates:
        k_nets = fl.local_update_read(glob_knwl_net, selected, args, net_dataidx_map, test_dl_global, logger,
        ...
        save_checkpoint( glob_knwl_net.module if isinstance(glob_knwl_net,
                                                                        torch.nn.DataParallel) else glob_knwl_net,

        "knowledge", checkpoint_dir=args.outdir)
